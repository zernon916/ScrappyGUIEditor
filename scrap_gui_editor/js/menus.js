...
export function widgetMenuItems(ctx) {
  ...
  return [
    ...
    { sep: true },
    { cmd: "selectParent", label: "Select Parent", disabled: !ctx.hasParent },
    { cmd: "groupSel", label: "Group", shortcut: "Ctrl+G", disabled: ctx.selectionCount < 2 },
    { cmd: "ungroupSel", label: "Ungroup", shortcut: "Ctrl+Shift+G", disabled: !ctx.hasActiveGroup },
    {
      label: "Fit / Center",
      submenu: [
        { cmd: "fitParent", label: "Fit to Parent", disabled: !ctx.hasSelection || ctx.targetLocked },
        { cmd: "centerInParent", label: "Center in Parent", disabled: !ctx.hasSelection || ctx.targetLocked },
        { cmd: "centerH", label: "Center Horizontally", disabled: !ctx.hasSelection || ctx.targetLocked },
        { cmd: "centerV", label: "Center Vertically", disabled: !ctx.hasSelection || ctx.targetLocked },
      ],
    },
    { sep: true },
    ...
    { sep: true },
    { cmd: "replaceImage", label: "Replace Image…", disabled: !ctx.canReplaceImage },
  ...
  return [
    {
      ...
      items: [
        ...
        { cmd: "pickLayoutsFolder", label: "Layouts Folder…" },
        { cmd: "pickImagesFolder", label: "Images Folder…" },
        {
          label: "Open Recent",
    ...
    },
    {
      ...
      items: [
        ...
        { cmd: "toggleGrid", label: "Show Grid", checked: ctx.showGrid },
        { cmd: "toggleSnap", label: "Enable Snap", checked: ctx.snap },
        { cmd: "toggleChecker", label: "Checkerboard", checked: ctx.checker },
        ...
        { sep: true },
        { cmd: "toggleLeftPanel", label: "Hierarchy Panel", shortcut: "N", checked: !ctx.leftCollapsed },
        { cmd: "toggleRightPanel", label: "Properties Panel", shortcut: "Ctrl+N", checked: !ctx.rightCollapsed },
        { sep: true },
    ...
    },
    {
      ...
      label: "Tools",
      items: [
        { cmd: "toolSelect", label: "Select", shortcut: "Q", checked: ctx.tool === "select" },
        { cmd: "toolBox", label: "Box Select", shortcut: "B", checked: ctx.tool === "box" },
        { cmd: "toolMove", label: "Move", shortcut: "W", checked: ctx.tool === "move" },
        { cmd: "toolScale", label: "Scale", shortcut: "E", checked: ctx.tool === "scale" },
      ],
    },
    {
      id: "help",
